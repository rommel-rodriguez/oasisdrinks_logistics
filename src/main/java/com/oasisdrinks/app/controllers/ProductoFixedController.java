 ...
 */
public class ProductoFixedController implements ActionListener, ListSelectionListener {

    private MedidaService modelService;
    private MedidaView view;
    private ConnectionFactory conFactory;

    public ProductoFixedController(MedidaService modelService, MedidaView view) {
